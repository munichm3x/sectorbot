...
export const serverInfoAdminRouter = Router();
serverInfoAdminRouter.use(requirePermission(PermLevel.Moderator));
...
// GET /api/server-info
serverInfoAdminRouter.get('/', (req, res) => {
  try {
...
serverInfoAdminRouter.put('/', (req, res) => {
  try {
