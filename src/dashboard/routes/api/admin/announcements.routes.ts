...
announcementsAdminRouter.get('/', (req, res) => {
  try {
...
announcementsAdminRouter.get('/:id', (req, res) => {
  try {
...
announcementsAdminRouter.post('/', (req, res) => {
  try {
...
announcementsAdminRouter.patch('/:id', (req, res) => {
  try {
    const id = Number(req.params.id);
    const user = req.session.user!;
    if (!Number.isFinite(id)) {
...
announcementsAdminRouter.delete('/:id', (req, res) => {
  try {
    const id = Number(req.params.id);
    const user = req.session.user!;
    if (!Number.isFinite(id)) {
